...
class CarlaRunner:
    ...
    def eval(self, data_loader):
        ...
        while len(data_loader) > 0:
            ...
            # save video
            if self.scenario_category == 'planning':
                self.video_recorder.save(video_name=f'video_{video_count}_{self.exp_name}.gif')
            else: 
                self.video_recorder.save(video_name=f'video_{video_count}_{self.exp_name}.mp4')
